...
const sectionCards: Record<SectionId, { title: string; description: string }> = {
  ...
  cyberpunkTopLanguages: { title: 'CyberPunk Top Languages', description: 'Neon cyberpunk top-languages card.' },
